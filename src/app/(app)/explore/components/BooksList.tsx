...
import { getExploreBooks } from "../actions";
  ...
  return (
    <div>
      {books.length && !loading ? (
        <div className="grid grid-cols-[repeat(auto-fill,_minmax(320px,_1fr))] gap-5">
          {books.map((book) => {
            return (
              <SmallCard
                key={book.id}
      ...
      {loading ? (
        <div className="flex items-center justify-center">
          <div role="status" className="my-5 mx-auto">
            <svg
              aria-hidden="true"
              className="w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-gray700"
              viewBox="0 0 100 101"
              fill="none"
